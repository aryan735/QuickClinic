...
public interface PatientRepository extends JpaRepository <PatientModel,Long> {
    @Query("SELECT new com.quickclinic.patient.controller.dtos.PatientResponseDto(u.status,u.patientId,u.userId,u.doctorId,u.doctorName,u.name,u.email,u.dob,u.age,u.gender,u.phoneNo,u.alternativePhoneNo,u.address,u.city,u.state,u.zip,u.createdTime,u.updatedTime) FROM PatientModel u WHERE u.userId= :userId")
