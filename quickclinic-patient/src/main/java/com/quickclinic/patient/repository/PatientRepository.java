...
public interface PatientRepository extends JpaRepository <PatientModel,Long> {
   ...
   @Modifying
    ...
    int updatePatientDetails(@Param("doctorName") String doctorName, @Param("doctorId") Long doctorId, @Param("name") String name, @Param("email") String email, @Param("dob") String dob,@Param("age") int age, @Param("gender") String gender, @Param("phoneNo") String phoneNo, @Param("altNo") String altNo, @Param("address") String address, @Param("city") String city, @Param("state") String state, @Param("zip") String zip, @Param("patientId") Long patientId);
}
